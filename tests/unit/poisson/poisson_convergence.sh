...
# Poisson Convergence Test Script
# Usage: poisson_convergence.sh [path_to_poisson_DMStag_2D_executable]

# Get executable path from argument or use default
POISSON_EXEC="${1:-./poisson_DMStag_2D}"
...
echo "=== Poisson Equation Convergence Test ==="
