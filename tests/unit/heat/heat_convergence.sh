...
# Heat Equation Convergence Test Script
# Usage: heat_convergence.sh [path_to_heat_DMStag_2D_executable]
...
echo "=== Heat Equation Convergence Test ==="
echo "Testing spatial convergence with element-centered DMStag"
...
for i in "${!sizes[@]}"; do
  ...
  # dt = C * h^2, where C is chosen such that the CFL condition is satisfied
