	...
	while (t <= t_end && t <=4.2) {
		...
		if (judge_num == 1 || judge_num % 32 == 0){
			...
			if (Petsc_rank == FS.root){
				...
				//欧拉点				
				char velocity_u_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/velocity_u" };
				char velocity_v_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/velocity_v" };
				char velocity_w_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/velocity_w" };
				char pressure_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/pressure" };

				char FF00_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF00_" };
				char FF01_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF01_" };
				char FF02_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF02_" };
				char FF10_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF10_" };
				char FF11_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF11_" };
				char FF12_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF12_" };
				char FF20_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF20_" };
				char FF21_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF21_" };
				char FF22_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF22_" };

				char FF_inv00_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv00_" };
				char FF_inv01_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv01_" };
				char FF_inv02_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv02_" };
				char FF_inv10_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv10_" };
				char FF_inv11_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv11_" };
				char FF_inv12_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv12_" };
				char FF_inv20_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv20_" };
				char FF_inv21_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv21_" };
				char FF_inv22_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv22_" };

				char phi_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/phi" };

				//拉格朗日点
				char Lagrange_node_x_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/Lagrange_node_x" };
				char Lagrange_node_y_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/Lagrange_node_y" };
				char Lagrange_node_z_name[] = { "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/Lagrange_node_z" };
...
void get_initial_value(double * CPP_Lagrange_node_x, double * CPP_Lagrange_node_y, double * CPP_Lagrange_node_z, int Lagrange_node_num)
{
	...
	sprintf(input_Lagrange_node_name, "/Users/pengfei/Documents/GitHub/cross_platform/oscillating_disk_wyh/cricle_domain_nodes.txt");
	...
	for (int i = 0; i < Lagrange_node_num; i++) {
		for (int j = 0; j < 3; j++){
			if (j == 0){
				...
				CPP_Lagrange_node_x[i] = CPP_Lagrange_node_x[i] + 0.5;
			}
			if (j == 1){
	...
	int all_mesh_num, int Lagrange_node_num, int judge_num)
{
	...
	sprintf(input_Lagrange_node_x_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/Lagrange_node_x%d%s", judge_num, ".txt");
	sprintf(input_Lagrange_node_y_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/Lagrange_node_y%d%s", judge_num, ".txt");
	sprintf(input_Lagrange_node_z_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/Lagrange_node_z%d%s", judge_num, ".txt");

	sprintf(input_velocity_u_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/velocity_u%d%s", judge_num, ".txt");
	sprintf(input_velocity_v_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/velocity_v%d%s", judge_num, ".txt");
	sprintf(input_velocity_w_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/velocity_w%d%s", judge_num, ".txt");

	sprintf(input_pressure_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/pressure%d%s", judge_num, ".txt");
	sprintf(input_phi_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/phi%d%s", judge_num, ".txt");

	sprintf(input_FF00_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF00_%d%s", judge_num, ".txt");
	sprintf(input_FF10_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF10_%d%s", judge_num, ".txt");
	sprintf(input_FF20_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF20_%d%s", judge_num, ".txt");

	sprintf(input_FF01_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF01_%d%s", judge_num, ".txt");
	sprintf(input_FF11_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF11_%d%s", judge_num, ".txt");
	sprintf(input_FF21_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF21_%d%s", judge_num, ".txt");

	sprintf(input_FF02_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF02_%d%s", judge_num, ".txt");
	sprintf(input_FF12_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF12_%d%s", judge_num, ".txt");
	sprintf(input_FF22_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF22_%d%s", judge_num, ".txt");

	sprintf(input_FF_inv00_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv00_%d%s", judge_num, ".txt");
	sprintf(input_FF_inv10_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv10_%d%s", judge_num, ".txt");
	sprintf(input_FF_inv20_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv20_%d%s", judge_num, ".txt");

	sprintf(input_FF_inv01_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv01_%d%s", judge_num, ".txt");
	sprintf(input_FF_inv11_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv11_%d%s", judge_num, ".txt");
	sprintf(input_FF_inv21_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv21_%d%s", judge_num, ".txt");

	sprintf(input_FF_inv02_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv02_%d%s", judge_num, ".txt");
	sprintf(input_FF_inv12_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv12_%d%s", judge_num, ".txt");
	sprintf(input_FF_inv22_name, "/home/large/ibamr/wyh/wyh_PETSc/PETSC_fulid_solid_thirteen/fluid_solid/3D/oscillating_disk/data/FF_inv22_%d%s", judge_num, ".txt");
