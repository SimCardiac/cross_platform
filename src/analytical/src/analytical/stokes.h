...
static inline PetscScalar u_exact(PetscScalar x, PetscScalar y, PetscScalar t) {
  return (PetscScalar)(-std::exp(-2.0 * std::pow(M_PI, 2) * t) *
                       std::sin(M_PI * y) * std::cos(M_PI * x));
}
...
static inline PetscScalar fx_heat(PetscScalar, PetscScalar, PetscScalar) {
  return 0.0;
}
static inline PetscScalar fy_heat(PetscScalar, PetscScalar, PetscScalar) {
  return 0.0;
}
